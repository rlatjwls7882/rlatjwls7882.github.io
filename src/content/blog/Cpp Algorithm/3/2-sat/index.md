...
description: '2-\href{https://ko.wikipedia.org/wiki/논리곱_표준형}{CNF}를 \href{https://en.wikipedia.org/wiki/Implication_graph}{Implication Graph}로 바꾸고 SCC로 만족 가능성을 판별하는 알고리즘'
complexity: '$O(V+E)$'
---
