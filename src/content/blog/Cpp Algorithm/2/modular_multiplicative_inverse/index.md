...
정수 $a$의 모듈러 역원은 다음 조건을 만족하는 정수 $a^{-1}$이다.
...
모듈러 연산에서 덧셈과 곱셈은 나머지를 먼저 구해도 된다.
...
하지만 나눗셈은 같은 방식으로 처리할 수 없다.

$$
\frac{a}{b}\bmod m \neq \frac{a\bmod m}{b\bmod m}\bmod m
$$

따라서 $b$로 나누는 대신 $b$의 모듈러 역원 $b^{-1}$을 곱한다.
...
$m$이 소수이고 $a$가 $m$의 배수가 아니라면 다음 식이 성립한다.
